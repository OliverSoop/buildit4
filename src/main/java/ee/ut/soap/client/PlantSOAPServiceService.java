 ...
 * 
 */
@WebServiceClient(name = "PlantSOAPServiceService", targetNamespace = "http://web.soap.ut.ee/", wsdlLocation = "http://rentit4.herokuapp.com/PlantSOAPService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PLANTSOAPSERVICESERVICE_QNAME = new QName("http://web.soap.ut.ee/", "PlantSOAPServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://rentit4.herokuapp.com/PlantSOAPService?wsdl");
    ...
    public PlantSOAPService getPlantSOAPServicePort() {
        return super.getPort(new QName("http://web.soap.ut.ee/", "PlantSOAPServicePort"), PlantSOAPService.class);
    }
    ...
    public PlantSOAPService getPlantSOAPServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://web.soap.ut.ee/", "PlantSOAPServicePort"), PlantSOAPService.class, features);
    }
